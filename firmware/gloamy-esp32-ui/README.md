# Gloamy ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for Gloamy edge scenarios on ESP32.
...
3. Connect UI state with Gloamy edge/runtime messaging
...
- [Gloamy Hardware Design](../../docs/hardware-peripherals-design.md)
