# Gloamy PR Workflow (High-Volume Collaboration)

This document defines how Gloamy handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to Gloamy/project-native labels.
...
- Confirm any required identity-like wording uses Gloamy/project-native terminology.
