...
Cách cài đặt và khởi tạo Gloamy nhanh nhất.
...
Mặc định là **chỉ ứng dụng** (build/cài Gloamy), yêu cầu Rust toolchain sẵn có.
...
Lệnh này build image Gloamy cục bộ và chạy thiết lập trong container, lưu config/workspace vào `./.gloamy-docker`.
