...
|---------|-----------|--------------|--------|
| **Gloamy cơ bản** | 3.4MB | <5MB | ✅ Hiện tại |
...
| Phần cứng | RAM | Gloamy (cơ bản) | Gloamy (full security) | Trạng thái |
|----------|-----|-----------------|--------------------------|--------|
...
**Ngay cả với full security, Gloamy chỉ dùng <5% RAM trên board $10.**

---

## 5. Tính hoán đổi: mọi thứ vẫn pluggable

### Cam kết chính của Gloamy: hoán đổi bất kỳ thứ gì
