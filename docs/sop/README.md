...
- CLI `gloamy sop` currently manages definitions only: `list`, `validate`, `show`.
...
2. Create a SOP directory, for example:
   ...
   ```text
   ~/.gloamy/workspace/sops/deploy-prod/SOP.toml
   ~/.gloamy/workspace/sops/deploy-prod/SOP.md
   ```
