# Tài liệu tham khảo Providers — Gloamy
...
3. Biến môi trường dự phòng chung: `GLOAMY_API_KEY`, sau đó là `API_KEY`
...
- Sau khi chuẩn hóa multimodal, Gloamy gửi payload hình ảnh qua trường `messages[].images` gốc của Ollama.
- Nếu chọn provider không hỗ trợ vision, Gloamy trả về lỗi rõ ràng thay vì âm thầm bỏ qua hình ảnh.
...
- Khám phá model: `gloamy models refresh --provider nvidia`
