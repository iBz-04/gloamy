...
## Problem
Gloamy logs actions but lacks tamper-evident audit trails for:
...
# Tamper evidence
sign_events = true
signing_key_path = "~/.config/gloamy/audit.key"
...
gloamy audit --user @alice

# Show all high-risk commands
gloamy audit --risk high

# Show violations from last 24 hours
gloamy audit --since 24h --violations-only

# Export to JSON for analysis
gloamy audit --format json --output audit.json
