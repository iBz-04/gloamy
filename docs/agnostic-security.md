...
| Hardware | RAM | Gloamy (base) | Gloamy (full security) | Status |
|----------|-----|-----------------|--------------------------|--------|
...
**Even with full security, Gloamy uses <5% of RAM on $10 boards.**

---

## 5. Agnostic Swaps: Everything Remains Pluggable

### Gloamy's Core Promise: Swap Anything
