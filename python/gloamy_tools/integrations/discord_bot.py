"""
Discord bot integration for Gloamy.
"""
...
class DiscordBot:
    """
    Discord bot powered by Gloamy agent with LangGraph tool calling.
    ...
    def __init__(
        ...
        if not DISCORD_AVAILABLE:
            raise ImportError(
                ...
                "Install with: pip install gloamy-tools[discord]"
            )
    ...
    def _setup_events(self):
        @self.client.event
        async def on_ready():
            print(f"Gloamy Discord Bot ready: {self.client.user}")
