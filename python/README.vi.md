...
Gói Python đồng hành cho [Gloamy](https://github.com/iBz-04/gloamy) — gọi công cụ dựa trên LangGraph cho thực thi agent LLM nhất quán.
...
| Tính năng | Rust Gloamy | gloamy-tools |
|---------|---------------|----------------|
...
Dùng **Rust Gloamy** cho triển khai biên (edge) trong sản phẩm. Dùng **gloamy-tools** khi cần đảm bảo tính nhất quán gọi công cụ hoặc tích hợp hệ sinh thái Python.
