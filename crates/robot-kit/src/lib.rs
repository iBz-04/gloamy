//! # Gloamy Robot Kit
//!
//! A standalone robotics toolkit that integrates with Gloamy for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  Gloamy AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use gloamy_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of Gloamy. It defines its own
//! `Tool` trait that is compatible with Gloamy's but doesn't require it.
//!
//! ## Safety
//!
