...
const router = createRouter({
  // Hash history keeps the bundle servable from any static host with no
  // rewrite rules, and its routes can never collide with the daemon's
  // same-origin API paths. Switch to createWebHistory() for clean URLs, which
  // also requires an SPA fallback on whatever serves dist/.
