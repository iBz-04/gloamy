...
async function probeDaemonPairing(baseUrl: string) {
  ...
  // An empty base URL means same-origin, which yields a relative `/health`
  // request the dev server / reverse proxy forwards to the daemon.
...
async function persistBaseUrlIfChanged(): Promise<string> {
  // Blank is meaningful: it selects the same-origin proxy path.
              ...
              <div class="space-y-4">
                ...
                <div class="space-y-1.5">
                  ...
                  <p class="text-[11px] text-muted-foreground">
                    Leave blank to reach the daemon through this app's own origin.
                  </p>
                  <div class="flex gap-2">
                    <input
                      ...
                      placeholder="Same origin (proxied)"
