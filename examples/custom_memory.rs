//! Example: Implementing a custom Memory backend for Gloamy
//!
...
// ── Re-define the trait types (in your app, import from gloamy::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 Gloamy Memory Demo — InMemoryBackend\n");
