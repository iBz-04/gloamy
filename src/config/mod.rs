...
pub use schema::{
    ...
    EstopConfig, FeishuConfig, GatewayConfig, GuiApprovalGate, GuiApprovalThreshold,
    GuiVerificationConfig, HardwareConfig, HardwareTransport, HeartbeatConfig, HooksConfig,
    HttpRequestConfig, IMessageConfig, IdentityConfig, LarkConfig, MatrixConfig, MemoryConfig,
    ModelRouteConfig, MultimodalConfig, NextcloudTalkConfig, ObservabilityConfig, OneConfig,
    ...
    TunnelConfig, VoiceReplyMode, WebFetchConfig, WebSearchConfig, WebhookConfig,
};
