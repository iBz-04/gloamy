...
/// Handle `gloamy peripheral` subcommands.
    ...
    match cmd {
        crate::PeripheralCommands::List => {
            ...
            if boards.is_empty() {
                ...
                println!();
                println!("Add one with: gloamy peripheral add <board> <path>");
                println!("  Example: gloamy peripheral add nucleo-f401re /dev/ttyACM0");
                println!();
