...
use gloamy::providers::compatible::AuthStyle;
use gloamy::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use gloamy::providers::compatible::OpenAiCompatibleProvider;
